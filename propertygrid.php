    ...
    <div class="row"> 
        ...
        <div class="banner-full-row page-banner" style="background-image:url('images/breadcromb.jpg');">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <h2 class="page-name float-left text-white text-uppercase mt-1 mb-0"><b>بحث عن عقارات</b></h2>
                    </div><!-- FOR MORE PROJECTS visit: codeastro.com -->
                    <div class="col-md-6">
                        <nav aria-label="breadcrumb" class="float-left float-md-right">
                            <ol class="breadcrumb bg-transparent m-0 p-0">
                                <li class="breadcrumb-item text-white"><a href="index.php">الرئيسية</a></li>
                                <li class="breadcrumb-item active">بحث عن عقارات</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                ...
                <div class="row">
					...
					<div class="col-lg-8">
						...
						<!-- FOR MORE PROJECTS visit: codeastro.com -->
                            ...
                            <div class="col-md-6">
                                <div class="featured-thumb hover-zoomer mb-4">
                                    <div class="overlay-black overflow-hidden position-relative"> <img src="admin/property/<?php echo $row['18'];?>" alt="pimage">
                                        ...
                                        <div class="price text-primary text-capitalize">$<?php echo $row['13'];?> <span class="text-white"><?php echo $row['12'];?> قدم مربع</span></div>
                            ...
                            <?php 		
									...
									echo "<h1 class='mb-5'><center>هذا العرض غير متوفر</center></h1>";
								}
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="sidebar-widget mt-5">
                            <h4 class="double-down-line-left text-secondary position-relative pb-4 mb-4">العروض المضافة حديثا</h4>
