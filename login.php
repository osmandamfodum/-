	...
	if(!empty($email) && !empty($pass))
	{
		...
		$row=mysqli_fetch_array($result);
		   if($row){
			   ...
			   $error = "<p class='alert alert-warning'>!...البريد الالكتروني او كلمة المرور غير متطابقان </p> ";
		   }
	}else{
							...
							<div class="login-right-wrap">
								...
								<form method="post">
									...
									<div class="form-group">
										...
										<button class="btn btn-success" name="login" value="Login" type="submit">دخول</button>
								...
								<div class="text-center dont-have">ليس لدي حساب ؟ <a href="register.php">تسجيل جديد</a></div>
