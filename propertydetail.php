                    ...
                    <div class="col-md-6">
                        <nav aria-label="breadcrumb" class="float-left float-md-right">
                            <ol class="breadcrumb bg-transparent m-0 p-0">
                                <li class="breadcrumb-item text-white"><a href="index.php">الرئيسية</a></li>
            ...
            <div class="container">
                <div class="row"><!-- FOR MORE PROJECTS visit: codeastro.com -->
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="property-details">
                            <div class="bg-gray property-quantity px-4 pt-4 w-100">
                                <ul>
                                    <li><span class="text-secondary"><?php echo $row['12'];?></span> قدم مربع</li>
                                    <li><span class="text-secondary"><?php echo $row['6'];?></span> الغرف</li>
                                    <li><span class="text-secondary"><?php echo $row['7'];?></span> دورة المياة</li>
                                    <li><span class="text-secondary"><?php echo $row['8'];?></span> الشرفة</li>
                                    <li><span class="text-secondary"><?php echo $row['10'];?></span> هول</li>
                            ...
                            <h5 class="mt-5 mb-4 text-secondary">خطط المبنى</h5>
                            <div class="accordion" id="accordionExample">
                                <button class="bg-gray hover-bg-success hover-text-white text-ordinary py-3 px-4 mb-1 w-100 text-left rounded position-relative" type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne"> خرطه المبني </button>
                                ...
                                <button class="bg-gray hover-bg-success hover-text-white text-ordinary py-3 px-4 mb-1 w-100 text-left rounded position-relative collapsed" type="button" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">الطابق الارضي</button>
                                ...
                                <button class="bg-gray hover-bg-success hover-text-white text-ordinary py-3 px-4 mb-1 w-100 text-left rounded position-relative collapsed" type="button" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">الجدران</button>
                            ...
                            <h5 class="mt-5 mb-4 text-secondary double-down-line-left position-relative">تواصل مع الوكيل</h5>
                    ...
                    <div class="col-lg-4">
                        ...
                        <h4 class="double-down-line-left text-secondary position-relative pb-4 my-4">حاسبة الاقساط</h4>
                        <form class="d-inline-block w-100" action="calc.php" method="post">
                            ...
                            <div class="input-group mb-2 mr-sm-2">
                                ...
                                <input type="text" class="form-control" name="month" placeholder="المدة بالشهر">
                            </div>
                            <label class="sr-only">سعر الفائدة</label>
                            <div class="input-group mb-2 mr-sm-2">
                                <div class="input-group-prepend">
                                    <div class="input-group-text">%</div>
                                </div>
                                <input type="text" class="form-control" name="interest" placeholder="سعر الفائدة">
                            </div>
                            <button type="submit" value="submit" name="calc" class="btn btn-danger mt-4">حاسبة الاقساط </button>
                        </form>
                        <h4 class="double-down-line-left text-secondary position-relative pb-4 mb-4 mt-5">عقارات مميزه</h4>
                        ...
                        <div class="sidebar-widget mt-5">
                            <h4 class="double-down-line-left text-secondary position-relative pb-4 mb-4">العقارات المضافة حديثا</h4>
                            <ul class="property_list_widget">
