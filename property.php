                    ...
                    <div class="col-lg-4">
						...
						<form class="d-inline-block w-100" action="calc.php" method="post">
                            ...
                            <div class="input-group mb-2 mr-sm-2">
                                ...
                                <input type="text" class="form-control" name="month" placeholder="المده بالسنه">
                            </div>
                        ...
                        <h4 class="double-down-line-left text-secondary position-relative pb-4 mb-4 mt-5">عقارات مميزة</h4>
