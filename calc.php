    ...
    <div class="row"> 
        ...
        <div class="full-row bg-gray">
            <div class="container">
                    <div class="row mb-5">
						<div class="col-lg-12">
							<h2 class="text-secondary double-down-line text-center"> حاسبة الاقساط</h2>
                        </div>
					</div>
					<center>
					<table class="items-list col-lg-6 table-hover" style="border-collapse:inherit;">
                        <thead>
                             <tr  class="bg-secondary">
                                <th class="text-white font-weight-bolder">الشرط</th>
                                <th class="text-white font-weight-bolder">مبلغ</th>
                             </tr>
                        </thead>
                        <tbody>
